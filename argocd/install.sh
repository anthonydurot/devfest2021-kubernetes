...
argocd app create sealed-secrets --repo https://github.com/anthonydurot/devfest2021-kubernetes.git --revision main --path  application/sealed-secrets --dest-server https://kubernetes.default.svc --dest-namespace sealed-secrets --sync-option CreateNamespace=true --sync-policy automatic